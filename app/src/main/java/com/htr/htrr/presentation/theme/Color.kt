...
val CoralPink = Color(0xFFFF8A95)

val RoyalGold = Color(0xFFFBBF24)
...
val DarkOnSecondary = Color(0xFF581C87)
val DarkSecondaryContainer = Color(0xFF6D28D9)
val DarkOnSecondaryContainer = Color(0xFFF3E8FF)
